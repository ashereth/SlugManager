...
import { Tasks } from "./database/tasksClass.js";           // import tasks class
...
app.post("/register", async (req, res) => {
    ...
    try {
        // make sure user doesn't already exist by calling createUser
        ...
        if (success) {
            ...
            // if it wasn't a new user send an error and reload
...
// handles post request for marking a task as complete
